---
title: Home
description: A self-hosted Open-Source Unified Endpoint Manager that lets you manage your IT assets via agents
keywords:
  [
    IT assets,
    inventory,
...
- An unified endpoint management tool (UEM)
...
Well, why another car model?, why another IA?, why another programming language? Because there are different points of view and ways to satisfy similar needs.
