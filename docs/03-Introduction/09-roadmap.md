...
- Scripts for easier deployment of agents, certificates and configuration 
- Support for common VPN solutions to configure tunnels in Managed Service Providers scenarios (NetBird, Wireguard, OpenVPN...) 
- Configuration examples for more proxies (Traefik, HAProxy...)  
...
You can visit [GitHub](https://github.com/open-uem/openuem-console/issues?q=is%3Aissue%20state%3Aopen%20type%3AFeature) to check the features we’re working on 
