...
- **Create configuration profiles with automated tasks that can be applied to your Windows endpoints**. You can select packages to install or uninstall using WinGet and manage registry keys, local users and local groups. Also you can run basic PowerShell scripts and manage MSI packages (🎯 Version 0.8.0). Use these profiles to perform post-install tasks
- **Create configuration profiles with automated tasks that can be applied to your Linux endpoints**. You can select packages to install or uninstall using Flatpak, manage local users and local groups and execute basic shell scripts (🎯 Version 0.8.0). Use these profiles to perform post-install tasks
- **Create configuration profiles with automated tasks that can be applied to your MacOS endpoints**. You can select packages to install or uninstall using Brew, manage local users and local groups and execute basic shell scripts (🎯 Version 0.8.0). Use these profiles to perform post-install tasks
...
- Remove printers or set default printers. Agents must be at least 0.6.0 and server at least 0.7.0.
